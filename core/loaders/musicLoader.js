...
const eventTable = new ascii().setTitle('Music Loader').setHeading('Directory', 'Event', 'Load Status', 'Run Type');
const getAllFiles = require('../../functions/helpers/getAllFiles');
const { join } = require('path');

module.exports = (client) => {
	// Read the music events directory
	const eventFolders = getAllFiles(join(__dirname, '../', '../musicevents'), true);
